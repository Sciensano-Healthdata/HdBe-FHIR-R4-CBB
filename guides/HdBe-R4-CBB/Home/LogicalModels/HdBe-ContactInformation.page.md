...
<div>
  ...
  <div id="Rendered view" class="tabcontent" style="display:block">
    <br>
      {{render:https://fhir.healthdata.be/StructureDefinition/LogicalModel/HdBe-ContactInformation, snapshot}}
  </div>
  ...
  <div id="Example" class="tabcontent">
      {{render:logical models/HdBe-ContactInformation.example.md}}
  </div>

  <div id="Zib diff" class="tabcontent">
      {{render:logical models/HdBe-ContactInformation.doc.md}}
  </div>
