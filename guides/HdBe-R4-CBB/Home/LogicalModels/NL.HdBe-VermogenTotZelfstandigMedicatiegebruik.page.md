---
topic: NL.HdBe-VermogenTotZelfstandigMedicatiegebruik
lang: nl-BE
---

<div style="float:right;width:85px;padding:10px;margin:10">
<p>{{pagelink:EN.HdBe-AbilityToManageMedication, text:EN}}  {{pagelink:NL.HdBe-VermogenTotZelfstandigMedicatiegebruik, text:NL}}  <p>
</div>

# HdBe-VermogenTotZelfstandigMedicatiegebruik
...
<div>
  ...
  <div id="Rendered view" class="tabcontent" style="display:block">
    <br>
      {{tree:https://fhir.healthdata.be/StructureDefinition/LogicalModel/HdBe-AbilityToManageMedication , snapshot}}
  </div>
