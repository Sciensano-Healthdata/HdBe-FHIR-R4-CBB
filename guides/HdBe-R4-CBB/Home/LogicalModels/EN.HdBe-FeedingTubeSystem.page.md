---
topic: EN.HdBe-FeedingTubeSystem

---

<div style="float:right;width:85px;padding:10px;margin:10">
<p>{{pagelink:EN.HdBe-FeedingTubeSystem, text:EN}}  {{pagelink:NL.HdBe-SondeSysteem, text:NL}}  <p>
</div>
...
<div>
  ...
  <div id="Rendered view" class="tabcontent" style="display:block">
    <br>
      {{tree:https://fhir.healthdata.be/StructureDefinition/LogicalModel/HdBe-FeedingTubeSystem , snapshot}}
  </div>
