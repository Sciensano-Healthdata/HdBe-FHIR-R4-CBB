---
topic: EN.HdBe-FamilySituationChild

---

<div style="float:right;width:85px;padding:10px;margin:10">
<p>{{pagelink:EN.HdBe-FamilySituationChild, text:EN}}  {{pagelink:NL.HdBe-GezinssituatieKind, text:NL}}  <p>
</div>

# HdBe-FamilySituationChild
...
<div>
  ...
  <div id="Rendered view" class="tabcontent" style="display:block">
    <br>
      {{tree:https://fhir.healthdata.be/StructureDefinition/LogicalModel/HdBe-FamilySituationChild , snapshot}}
  </div>
  ...
  <div id="Example" class="tabcontent">
      {{render:logical models/LogicalModel-HdBe-FamilySituationChild.example.md}}
  </div>

  <div id="Zib diff" class="tabcontent">
      {{render:logical models/LogicalModel-HdBe-FamilySituationChild.doc.md}}
  </div>
