...
<div>
  <div class="tab">
     ...
     <button class="tablinks">{{pagelink:Home/Profiles/HdBe-Pregnancy.page.md, text:FHIR profile}}</button>
  </div>

  <div id="Rendered view" class="tabcontent" style="display:block">
    <br>
      {{render:https://fhir.healthdata.be/StructureDefinition/LogicalModel/HdBe-Pregnancy, snapshot}}
  </div>
