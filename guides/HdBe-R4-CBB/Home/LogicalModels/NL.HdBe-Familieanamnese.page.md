---
topic: NL.HdBe-Familieanamnese
lang: nl-NL
---

<div style="float:right;width:85px;padding:10px;margin:10">
<p>{{pagelink:EN.HdBe-FamilyHistory, text:EN}}  {{pagelink:NL.HdBe-Familieanamnese, text:NL}}  <p>
</div>

# HdBe-Familieanamnese
...
<div>
  ...
  <div id="Rendered view" class="tabcontent" style="display:block">
    <br>
      {{tree:https://fhir.healthdata.be/StructureDefinition/LogicalModel/HdBe-FamilyHistory , snapshot}}
  </div>
